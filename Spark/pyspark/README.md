...
* [PySpark dataframe add column based on other columns](https://www.geeksforgeeks.org/pyspark-dataframe-add-column-based-on-other-columns/)
* [PySpark: Dataframe Modify Columns](https://dbmstutorials.com/pyspark/spark-dataframe-modify-columns.html)
* [Change column values based on conditions in PySpark](https://che-kulhan.medium.com/change-column-values-based-on-conditions-in-pyspark-1f7563a2c39f)
* [PySpark Dataframe: Changing two Columns at the same time based on condition](https://stackoverflow.com/questions/44667565/pyspark-dataframe-changing-two-columns-at-the-same-time-based-on-condition)
* [PySpark Update a Column with Value](https://sparkbyexamples.com/pyspark/pyspark-update-a-column-with-value/?expand_article=1)
* [PySpark Convert Dictionary/Map to Multiple Columns](https://sparkbyexamples.com/pyspark/pyspark-convert-dictionary-map-to-multiple-columns/?expand_article=1)
* [PySpark create new column with mapping from a dict](https://www.geeksforgeeks.org/pyspark-create-new-column-with-mapping-from-a-dict/)
* [PySpark: create column based on value and dictionary in columns](https://stackoverflow.com/questions/74599729/pyspark-create-column-based-on-value-and-dictionary-in-columns)
* [Create a column based on values in a dictionary](https://stackoverflow.com/questions/70459994/create-a-column-based-on-values-in-a-dictionary)
* [One-hot encoding in PySpark](https://www.skytowner.com/explore/one_hot_encoding_in_pyspark)
* [How to do LabelEncoding or categorical value in Apache Spark](https://stackoverflow.com/questions/30580410/how-to-do-labelencoding-or-categorical-value-in-apache-spark)
* [Data Types - RDD-based API](https://spark.apache.org/docs/2.0.0/mllib-data-types.html)
* [PySpark Convert DataFrame to RDD](https://sparkbyexamples.com/pyspark/pyspark-convert-dataframe-to-rdd/)
